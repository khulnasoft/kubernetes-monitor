 ...
 * https://khulnasoft.slack.com/archives/CLW30N31V/p1612860708027800?thread_ts=1612856703.026500&cid=CLW30N31V
 */
function execWrapper(command) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, child_process_promise_1.exec)(command, { env: process.env })];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
}
exports.execWrapper = execWrapper;
