...
if [ $1 == "null" ]; then
  ...
  IMAGE_NAME_CANDIDATE=khulnasoft/kubernetes-monitor:staging-candidate-${CIRCLE_SHA1}
  IMAGE_NAME_APPROVED=khulnasoft/kubernetes-monitor:${1}-approved
  ...
  IMAGE_NAME_CANDIDATE_UBI9=khulnasoft/kubernetes-monitor:staging-candidate-ubi9-${CIRCLE_SHA1:0:8}
  IMAGE_NAME_APPROVED_UBI9=khulnasoft/kubernetes-monitor:${1}-ubi9-approved
