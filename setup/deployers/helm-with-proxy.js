...
exports.helmWithProxyDeployer = void 0;
var os_1 = require("os");
var fs_1 = require("fs");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    _a.label = 2;
                case 2: return [4 /*yield*/, kubectl.applyK8sYaml('test/fixtures/proxying/tinyproxy-service.yaml')];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, kubectl.applyK8sYaml('test/fixtures/proxying/tinyproxy-deployment.yaml')];
                case 4:
                    _a.sent();
                    return [4 /*yield*/, kubectl.waitForDeployment('forwarding-proxy', 'khulnasoft-monitor')];
                case 5:
                    _a.sent();
